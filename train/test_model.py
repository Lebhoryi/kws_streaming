...
def label_wav(dir_path, labels, graph, input_name, output_name, how_many_labels, average,
    ...
    for i in range(len(wav_paths)):
        ...
        label, d = run_graph(wav_data, labels_list, input_name, output_name, how_many_labels)
        ...
        if how_many_classes == 3:
            y_true[i] = 1 if dir_name == "xrxr" else 2
            y_pred[i] = 1 if label == "xrxr" else 2
        else:
            if dir_name == "niha":
                y_true[i] = 1
            elif dir_name == "xrxr":
